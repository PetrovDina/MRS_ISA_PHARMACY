...
insert into appointment (appointmentStatus, appointmentType, timePeriod, employee_id, price, pharmacy_id, deleted, patient_id) values ('RESERVED', 'PHARMACIST_CONSULTATION', '{ "startDate":  [2021, 5, 20], "startTime": [12, 0, 0], "endDate": [2021, 5, 20], "endTime": [13, 30, 0]}', 8, 1800, 2, 'False', 2);
insert into appointment (appointmentStatus, appointmentType, timePeriod, employee_id, price, pharmacy_id, deleted, patient_id) values ('RESERVED', 'PHARMACIST_CONSULTATION', '{ "startDate":  [2021, 5, 25], "startTime": [12, 0, 0], "endDate": [2021, 5, 25], "endTime": [13, 0, 0]}', 8, 1200, 2, 'False', 2);
...
insert into appointment (appointmentStatus, appointmentType, timePeriod, employee_id, price, pharmacy_id, deleted, patient_id) values ('RESERVED', 'DERMATOLOGIST_EXAMINATION', '{ "startDate":  [2021, 6, 5], "startTime": [12, 0, 0], "endDate": [2021, 6, 5], "endTime": [13, 30, 0]}', 4, 1800, 1, 'False', 2);
insert into appointment (appointmentStatus, appointmentType, timePeriod, employee_id, price, pharmacy_id, deleted, patient_id) values ('RESERVED', 'DERMATOLOGIST_EXAMINATION', '{ "startDate":  [2021, 5, 28], "startTime": [11, 0, 0], "endDate": [2021, 5, 28], "endTime": [12, 0, 0]}', 4, 1500, 1, 'False', 11);
insert into appointment (appointmentStatus, appointmentType, timePeriod, employee_id, price, pharmacy_id, deleted, patient_id) values ('RESERVED', 'DERMATOLOGIST_EXAMINATION', '{ "startDate":  [2021, 5, 23], "startTime": [12, 0, 0], "endDate": [2021, 5, 23], "endTime": [13, 30, 0]}', 4, 1400, 1, 'False', 2);
insert into appointment (appointmentStatus, appointmentType, timePeriod, employee_id, price, pharmacy_id, deleted, patient_id) values ('RESERVED', 'DERMATOLOGIST_EXAMINATION', '{ "startDate":  [2021, 5, 19], "startTime": [10, 0, 0], "endDate": [2021, 5, 19], "endTime": [11, 0, 0]}', 4, 1400, 1, 'False', 11);
