...
public class PrescriptionItemController {
	...
	public ResponseEntity<Void> savePrescriptionItemC(@RequestParam String storageId,@RequestParam String quantity,@RequestParam String duration,
			@RequestParam String appointmentId, @RequestParam String pharmacyId) {
		...
		prescriptionItem.setAppointment(appointment);
