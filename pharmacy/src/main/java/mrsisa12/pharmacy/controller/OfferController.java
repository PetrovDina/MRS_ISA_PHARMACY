...
public class OfferController {
	...
	public ResponseEntity<List<OfferWithOrderWithOrderItemsDTO>> getAllFromSupplier(@PathVariable String username) {
		...
		//List<OrderWithOrderItemsDTO> orderDTOs = new ArrayList<OrderWithOrderItemsDTO>();
		
		// Kreiram listu offerDTOs
		for (Offer offer : offers) 
		{
			OrderWithOrderItemsDTO orderWithOrderItemsDTO = 
					new OrderWithOrderItemsDTO(orderService.findOneWithOrderItems(offer.getOrder().getId()));
			
			OfferWithOrderWithOrderItemsDTO offerWithOrderItemsDTO = 
					new OfferWithOrderWithOrderItemsDTO(offer, orderWithOrderItemsDTO);
