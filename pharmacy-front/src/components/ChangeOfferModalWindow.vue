        ...
        <div class="modal-content">
            ...
            <form onsubmit="return false;">     	
                ...
                <button style="background: rgba(15, 95, 72, 0.95)" class="btn btn-info btn-md"  
                    @click="changeOffer(order, price, deliveryDueDate, offer)">
                    Send offer
                </button>
            </form>
...
export default {
    ...
    methods : {
        ...
        changeOffer : function(order, price, deliveryDueDate, offer)
        {
            ...
            this.$emit('change-offer-modal', order, price, moment(deliveryDueDate).format('YYYY-MM-DD'), offer.id);
            this.price = '';
