		            ...
		            <div id="registration-column" class="col-md-6">
		                <div id="registration-box" class="col-md-12">  
							<form onsubmit="return false;">  
		                        ...
		                        <div class="form-group">
		                            <label for="manufacturer" class="text-info">Manufacturer:</label><br>
		                        ...
		                        <div class="form-group">
									...
									<label for="req" style="color:#17a2b8">Prescription required</label>
									<input type="radio" id="notReq" name="prescriptionReq" value=false v-model="registration.prescriptionReq">
									<label for="notReq" style="color:#17a2b8">Not required</label>
		                        </div>
								<div class="form-group">
                                ...
                                <div class="dropdown" style="margin-top: 50px;">
                                        <label for="dropdownFormButton" class="text-info">Form:</label>
