<template>
    <div id="prescriptions">
        <p class="therapies-title">My ePrescriptions</p>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <prescription-items-table :mode="mode" :items="prescription.prescriptionItems"></prescription-items-table>
                                </div>
                            </div>
                        </div>
                    </div>
